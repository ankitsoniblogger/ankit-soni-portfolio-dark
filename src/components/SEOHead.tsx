...
import FaviconImg from "@/assets/ankit-soni-favicon.png";
...
const SEOHead = ({
  title = "Ankit Soni - Full Stack Developer & Digital Marketing Expert | Dubai",
  ...
  image = "@/assets/ankit-soni-favicon.png",
  ...
  return (
    <Helmet>
      ...
      <meta
        name="DC.subject"
        content="Web Development, Digital Marketing, WordPress, React.js"
      />
      ...
      <link rel="apple-touch-icon" sizes="180x180" href={FaviconImg} />
      <link rel="icon" type="image/png" sizes="32x32" href={FaviconImg} />
      <link rel="icon" type="image/png" sizes="16x16" href={FaviconImg} />
    </Helmet>
  );
};
