        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fadeInUp">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Passionate developer and strategic marketer crafting digital experiences that drive results
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative">
                ...
                <div className="relative bg-card rounded-3xl p-8 border border-border/50 shadow-card">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="text-2xl font-bold text-foreground mb-2">Ankit Soni</h3>
                    <p className="text-lg text-primary font-medium mb-6">Full Stack Developer & Digital Marketing Expert</p>
                    
                    <div className="grid grid-cols-2 gap-6 w-full">
                      <div className="text-center p-4 rounded-xl bg-muted/20">
                        <div className="text-2xl font-bold gradient-text-code">5+</div>
                      ...
                      <div className="text-center p-4 rounded-xl bg-muted/20">
                        <div className="text-2xl font-bold gradient-text-marketing">$500K+</div>
            ...
            <div className="animate-fadeInRight space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="card-gradient p-6 rounded-xl border border-border/50 hover:border-primary/50 transition-smooth group">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="text-xl font-semibold text-primary">Mission</h4>
                  </div>
                  <p className="text-muted-foreground">
                    Bridge the gap between cutting-edge technology and strategic marketing, 
                ...
                <div className="card-gradient p-6 rounded-xl border border-border/50 hover:border-primary/50 transition-smooth group">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="text-xl font-semibold text-primary">Approach</h4>
                  </div>
                  <p className="text-muted-foreground">
                    Understanding unique needs first, then combining technical expertise 
                    with creative problem-solving for exceptional results.
                  </p>
                </div>
                ...
                <div className="card-gradient p-6 rounded-xl border border-border/50 hover:border-primary/50 transition-smooth group md:col-span-2">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="text-xl font-semibold text-primary">Vision</h4>
                  </div>
                  <p className="text-muted-foreground">
                    Continuously evolving with the latest technologies and marketing trends, 
                    ensuring clients always stay ahead of the competition in the digital landscape.
                  </p>
                </div>
              </div>
            </div>
