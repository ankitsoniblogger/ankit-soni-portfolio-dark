const Experience = () => {
  const experiences = [
    {
      ...
      location: "Dubai, UAE",
      description:
        "Leading comprehensive digital transformation projects for international clients, combining advanced WordPress development with strategic digital marketing campaigns.",
      achievements: [
    ...
    },
    {
      ...
      location: "Remote",
      description:
        "Specialized in creating high-performance WordPress websites and implementing data-driven marketing strategies for SMEs and startups.",
      achievements: [
    ...
    },
    {
      ...
      location: "India",
      description:
        "Focused on full-stack web development and search engine optimization, building scalable solutions for emerging businesses.",
      achievements: [
  ...
  const ExperienceCard = ({
    ...
    >
      ...
      {/* Timeline Dot */}
      <div
        className={`absolute left-0 top-6 w-8 h-8 rounded-full border-2 border-primary flex items-center justify-center ml-0 ${
          experience.current ? "bg-primary animate-pulse" : "bg-background"
        }`}
      >
        <div
          className={`w-3 h-3 rounded-full ${
            experience.current ? "bg-primary-foreground" : "bg-primary"
          }`}
        ></div>
      </div>
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fadeInUp">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A journey of continuous growth and successful project deliveries
