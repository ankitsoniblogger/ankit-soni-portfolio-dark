...
const Footer = () => {
  ...
  return (
    <footer className="pt-16 pb-8 section-gradient border-t border-border/50">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="animate-fadeInUp">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Full Stack WordPress Developer & Digital Marketing Specialist
              based in Dubai, UAE. Creating exceptional digital experiences that
