...
const Hero = () => {
  ...
  return (
    <section className="min-h-[65vh] hero-gradient flex items-center justify-center relative overflow-hidden">
      {/* 3D Background */}
      ...
      <div className="container mx-auto pt-32 px-6 z-10 relative">
        <div className="text-center animate-fade-in-up">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12 max-w-4xl mx-auto">
            <div className="glass-effect p-6 rounded-2xl border border-primary/20 card-hover-effect">
              <h3 className="gradient-text-code text-lg font-bold mb-3">
                <CodeXml /> Developer
              </h3>
            ...
            <div className="glass-effect p-6 rounded-2xl border border-primary/20 card-hover-effect">
              <h3 className="gradient-text-marketing text-lg font-bold mb-3 ">
                <ChartNoAxesCombined /> Marketer
              </h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
